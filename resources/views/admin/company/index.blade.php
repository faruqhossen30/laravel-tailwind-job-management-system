...
@section('breadcrumb')
    <div class="flex justify-between items-center">
        <x-breadcrumb pageone="Careerlavel" />
        <x-button.button-plus route="{{ route('careerlavel.create') }}" title="Create careerlavel" />
    </div>
@endsection
@section('content')
                    ...
                    <div class="border rounded-lg overflow-hidden dark:border-gray-700">
                        <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                            ...
                            <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
                                @forelse ($careerlavels as $careerlavel)
                                    <tr>
                                        <td
                                            class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-800 dark:text-gray-200">
                                            {{ $careerlavels->firstItem() + $loop->index }}</td>
                                        <td
                                            class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-800 dark:text-gray-200">
                                            {{ $careerlavel->name }}
                                        </td>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-end text-sm font-medium">
                                            ...
                                            <x-table.crudactionbutton route="careerlavel" :id="$careerlavel->id" />
