<x-setting.setting-master title="Social Setting">
    ...
    <div class="p-4">
        <form action="{{ route('socialmedia.setting.store') }}" method="post" enctype="multipart/form-data">
            @csrf
            <div class="p-2">
                <label for="facebook_link" class="block text-sm font-medium mb-2 dark:text-white text-gray-500">Facebook Link</label>
            ...
            <div class="p-2">
                <label for="facebook_group_link" class="block text-sm font-medium mb-2 dark:text-white text-gray-500">Facebook Group
                    Link</label>
                <div class="flex rounded-lg shadow-sm">
                    <span
                        class="px-4 inline-flex items-center min-w-fit rounded-s-md border border-e-0 border-gray-200 bg-gray-50 text-sm text-gray-500 dark:bg-gray-700 dark:border-gray-700 dark:text-gray-400"><svg
            ...
            <div class="p-2">
                <label for="x_link" class="block text-sm font-medium mb-2 dark:text-white text-gray-500">X Link</label>
                <div class="flex rounded-lg shadow-sm">
                    <span
                        class="px-4 inline-flex items-center min-w-fit rounded-s-md border border-e-0 border-gray-200 bg-gray-50 text-sm text-gray-500 dark:bg-gray-700 dark:border-gray-700 dark:text-gray-400"><svg
                            xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                    ...
                    <input type="text" id="x_link" name="x_link" value="{{ $site->x_link }}"
                        class="  block w-full border-gray-200 shadow-sm rounded-0 text-sm focus:border-0 disabled:opacity-50 disabled:pointer-events-none dark:bg-slate-900 dark:border-gray-700 dark:text-gray-400 focus:outline-none focus:ring-0"
                        placeholder="https://twitter.com/">
                </div>
            </div>
            <div class="p-2">
                <label for="instagram_link" class="block text-sm font-medium mb-2 dark:text-white text-gray-500">Instagram
                    Link</label>
                <div class="flex rounded-lg shadow-sm ">
                    <span
                        class="px-4  inline-flex items-center min-w-fit rounded-s-md border border-e-0 border-gray-200 bg-gray-50 text-sm text-gray-500 dark:bg-gray-700 dark:border-gray-700 dark:text-gray-400"><svg
            ...
            <div class="p-2">
                <label for="whatsapp_link" class="block text-sm font-medium mb-2 dark:text-white text-gray-500">Whatsapp
                    Link</label>
                <div class="flex rounded-lg shadow-sm ">
                    <span
                        class="px-4  inline-flex items-center min-w-fit rounded-s-md border border-e-0 border-gray-200 bg-gray-50 text-sm text-gray-500 dark:bg-gray-700 dark:border-gray-700 dark:text-gray-400"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-whatsapp" viewBox="0 0 16 16">
                    ...
                    <input type="text" id="whatsapp_link" name="whatsapp_link" value="{{ $site->whatsapp_link }}"
                        class="  block w-full border-gray-200 shadow-sm rounded-0 text-sm focus:border-0 disabled:opacity-50 disabled:pointer-events-none dark:bg-slate-900 dark:border-gray-700 dark:text-gray-400 focus:outline-none focus:ring-0"
                        placeholder="www.instagram.com">
                </div>
            </div>
            ...
            <div class="p-2">
                <label for="linkedin_link" class="block text-sm font-medium mb-2 dark:text-white text-gray-500">Linkedin
                    Link</label>
                <div class="flex rounded-lg shadow-sm">
                    <span
                        class="px-4 inline-flex items-center min-w-fit rounded-s-md border border-e-0 border-gray-200 bg-gray-50 text-sm text-gray-500 dark:bg-gray-700 dark:border-gray-700 dark:text-gray-400"><svg
            ...
            <div class="p-2">
                <label for="youtube_link" class="block text-sm font-medium mb-2 dark:text-white text-gray-500">Youtube Link</label>
                <div class="flex rounded-lg shadow-sm">
                    <span
                        class="px-4 inline-flex items-center min-w-fit rounded-s-md border border-e-0 border-gray-200 bg-gray-50 text-sm text-gray-500 dark:bg-gray-700 dark:border-gray-700 dark:text-gray-400"><svg
                            xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
            ...
            {{-- <div class="p-2">
                <label for="Behance_link" class="block text-sm font-medium mb-2 dark:text-white">Behance Link</label>
                <div class="flex rounded-lg shadow-sm">
                    <span
                        class="px-4 inline-flex items-center min-w-fit rounded-s-md border border-e-0 border-gray-200 bg-gray-50 text-sm text-gray-500 dark:bg-gray-700 dark:border-gray-700 dark:text-gray-400"><svg
                            xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
            ...
            <div class="p-2">
                <label for="dribbble_link" class="block text-sm font-medium mb-2 dark:text-white">Dribbble
                    Link</label>
                <div class="flex rounded-lg shadow-sm">
                    <span
                        class="px-4 inline-flex items-center min-w-fit rounded-s-md border border-e-0 border-gray-200 bg-gray-50 text-sm text-gray-500 dark:bg-gray-700 dark:border-gray-700 dark:text-gray-400"><svg
            ...
            <div class="p-2">
                <label for="flickr_link" class="block text-sm font-medium mb-2 dark:text-white">Flickr Link</label>
                <div class="flex rounded-lg shadow-sm">
                    <span
                        class="px-4 inline-flex items-center min-w-fit rounded-s-md border border-e-0 border-gray-200 bg-gray-50 text-sm text-gray-500 dark:bg-gray-700 dark:border-gray-700 dark:text-gray-400"><svg
                            xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                            class="bi bi-voicemail" viewBox="0 0 16 16">
                            <path
